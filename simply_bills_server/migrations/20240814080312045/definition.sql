...
--
-- Class BillItem as table bill_item
--
...
--
-- Foreign relations for "bill_item" table
--
...
--
-- Foreign relations for "event" table
--
...
--
-- Foreign relations for "faq" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('simply_bills', '20240814080312045', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240814080312045', "timestamp" = now();
